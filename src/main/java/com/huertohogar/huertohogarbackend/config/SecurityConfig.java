    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/usuarios/login", "/api/v1/usuarios/register").permitAll()
                        ...
                        // GET /api/v1/usuarios/{id}, PUT /api/v1/usuarios/{id}, DELETE /api/v1/usuarios/{id}
                        // Nota: El PUT y DELETE necesitan manejo más complejo (ADMIN o self), pero por ahora lo dejamos como AUTH o ADMIN
                        .requestMatchers("/api/v1/usuarios/**").authenticated() // Protege el resto de rutas de usuario (GET/PUT/DELETE /id)
